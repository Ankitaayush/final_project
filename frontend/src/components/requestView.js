...
export default function RequestTable() {
  ...
  const [itemsPerPage, setItemsPerPage] = useState(100); // Set your desired items per page
                ...
                {({ open }) => (
                  <>
                    <AccordionHeader className="vendorButton2">
                      <div className="accordion-title request-header  acc-req final_style">
                        <h3 style={{ display: "inline" }}>{request.name}</h3>
                        <button
                    ...
                    {selectedItem.vendor.map((vendor) => (
                      <tr key={vendor.rqid}>
                        ...
                        <td>
                          ...
                          <>
                            <input
                              ...
                              type="file"
                              onChange={(e) => handleFileUpload(e, vendor.rqid)}
                            />
                        ...
                        <td>
                          <button
                            className="button"
                            onClick={(e) => handleFormSubmit(e, vendor.rqid)}
                          >
                            submit
                          </button>
                        </td>
