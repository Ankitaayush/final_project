...
const updateStatus = async (req, res) => {
  ...
  const sql =
    "UPDATE requeststatuses SET app1 = ?, manager_comment = ? WHERE rqid = ?";
...
const vpTrigger = (recipient) => {
  ...
  const mailOptions = {
    ...
    html: `
    <p>Dear VP, <br>I hope this email finds you well. I am writing to request your approval for the quotation we received for the purchase of IT assets for our team. Please visit the link below to approve the request.</p>
