...
const { createItem, getAllItems, getItem, deleteItems, getAllItemsForVendor } = require('../controllers/itTeamPage/itemController');
const { createVendor, getAllVendors, getVendor, updateVendor, deleteVendor } = require('../controllers/itTeamPage/vendorController');
...
let initAllItTeamRoutes = (app)=> {
    ...
    router.patch('/request/update', upload.single('quote'), itTeamPageController.updateRequest);
